...
var localization = {
  ...
  //English
  EN: {
    INTRO: '"What\'s it like being visually impaired?" As a well-sighted person you\'ll likely never fully get to understand that. But playing with ZIEN might allow you to imagine it.',
  ...
  // Dutch
  NL: {
    INTRO: '"Hoe is het om slechtziend te zijn?" Als goedziende mens kom je dat nooit helemaal te weten. Maar door te spelen met ZIEN kun je het je misschien iets beter voorstellen.',
